        ...
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
              <div class="nav flex-column nav-tabs  h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link"  data-toggle="pill" href="#theme" role="tab" aria-controls="theme" aria-selected="true"><i class="fa fa-brush"></i> {{__('Theme')}}</a>
            ...
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
              ...
              <!-- \Api Keys Settings -->
                ...
                <!-- Api keys Settings -->
                <div class="tab-pane text-left fade show" id="theme" role="tabpanel" aria-labelledby="theme">
                      <div class="card card-primary">
                          <div class="card-header">
                              <h5 class="card-title">{{__('Api Keys Settings')}}</h5>
                          </div>
                          <form action="{{route('admin.settings.themes')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <label for="google_map"> <i class="fas fa-map-marker-alt"></i> {{__('Theme')}}</label>
                                
                                <select class="form-control" name="theme">
                                    @foreach ($themes as $key=> $them)
                                       
                                        <option value="{{  $key }}" {{ $them ?'selected':'' }}>{{  $key }}</option>
                                    @endforeach
